...
```
yum install -y wget;wget --no-check-certificate https://raw.githubusercontent.com/janovas/TeamSpeak-3.0.10.3-Installer/master/install.sh; bash install.sh; rm -f install.sh
```
