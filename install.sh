...
if [[ ${architecture} == "x86_64" ]]; then
	...
	wget --no-check-certificate https://www.dropbox.com/s/ovnmaah2lmrwp5d/ts3server_linux_amd64?dl=1 -O ts3server_linux_amd64
	...
	wget --tries=5 --progress=bar:force http://dl.4players.de/ts/releases/3.0.10.3/teamspeak3-server_linux-x86-3.0.10.3.tar.gz -O teamspeak3-32.tar.gz 2>&1 | wget_filter
